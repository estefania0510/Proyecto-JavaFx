...
import co.edu.uptc.view.ConjuntosView;
...
public class ConjuntosPresenter {
    ...
    public ConjuntosPresenter(ConjuntosView view) {
        this.view = view;
    ...
    public void loadConjuntos() {
        ...
        for (Producto producto : productos) {
            if (producto.getCategoria().equals("Conjuntos Deportivos")) {
