...
import co.edu.uptc.presenter.SuplementosPresenter;

public class SuplementosView {
    @FXML
    ...
    private SuplementosPresenter presenter;

    public void initialize() {
        presenter = new SuplementosPresenter(this);

        btnAdd.setOnAction(event -> handleAdd());
        btnBack.setOnAction(event -> App.switchScene("PantallaInicial.fxml"));

        presenter.loadSuplementos();
    }
