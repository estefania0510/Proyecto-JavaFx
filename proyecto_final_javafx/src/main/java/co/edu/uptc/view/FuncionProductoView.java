...
import co.edu.uptc.presenter.FuncionProductoPresenter;

import java.util.Optional;

public class FuncionProductoView {
    @FXML
    ...
    private FuncionProductoPresenter presenter;

    public void initialize() {
        presenter = new FuncionProductoPresenter(this);
